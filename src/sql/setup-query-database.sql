...
-- Sample customers
INSERT INTO customers (name, email, phone, city, state, total_orders, total_spent) 
VALUES 
  ('John Smith', 'john.smith@email.com', '555-0101', 'New York', 'NY', 5, 1250.00),
  ('Sarah Johnson', 'sarah.j@email.com', '555-0102', 'Los Angeles', 'CA', 3, 890.50),
  ('Mike Brown', 'mike.brown@email.com', '555-0103', 'Chicago', 'IL', 7, 2100.75),
  ('Emily Davis', 'emily.davis@email.com', '555-0104', 'Houston', 'TX', 2, 345.20),
  ('David Wilson', 'david.w@email.com', '555-0105', 'Phoenix', 'AZ', 4, 675.80)
...
SELECT 
  ...
  COALESCE(SUM(o.total_amount), 0) as actual_spent,
